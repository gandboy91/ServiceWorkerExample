 ...
 */
const WrongRoute = (props) => (
  <h1 className="alert-danger p-3 rounded">Wrong url, dude!</h1>
);
...
const Forbidden = (props) => (
  <h1 className="alert-warning p-3 rounded">
    You are not supposed to be here, sorry, dude :(
  </h1>
);
          ...
          <div>
            ...
            <Switch>
              ...
              <PrivateRoute
                path="/cards/new"
                exact
                requiredAccessLevel={ADMIN_ACCESS_LEVEL}
                component={NewCard}
              />
              <PrivateRoute
                path="/cards/:id"
