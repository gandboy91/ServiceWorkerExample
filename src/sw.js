...
const pushWarningNotification = () =>
    self.registration.showNotification('say it to me asshole!', {
      ...
      actions: [
        { action: 'assh', title: 'yes, I am asshole' },
      ],
    })
